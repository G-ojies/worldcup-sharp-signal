...
Primary (≈270 chars incl. link):

> ⚡ SharpSignal — an autonomous agent for the TxLINE World Cup hackathon.
>
...
>
> ⚡ SharpSignal won't. It reads live TxLINE World Cup odds, catches the steam, and verifies every update on Solana before it moves — then settles itself.
>
